...
<div class="container">
    ...
    <div class="email-body">
        <p><strong>Dear Daily Pharmacy Team,</strong></p>
    ...
    <div class="email-footer">
        <p>&copy; 2024 Daily Pharmacy. All rights reserved.</p>
    </div>
</div>


{{-- <h1>{{ $details['greeting'] }}</h1>
<p>{{ $details['firstline'] }}</p>
<p><strong>Name:</strong> {{ $details['name'] }}</p>
<p><strong>Email:</strong> {{ $details['email'] }}</p>
<p><strong>Message:</strong></p>
<p>{{ $details['message'] }}</p>
<p><a href="{{ $details['url'] }}">{{ $details['button'] }}</a></p> --}}
</body>
</html>
